...
REM -XX:+UseParallelGC            The parallel collector maximizes throughput
REM -Dnetlogo.extensions.dir=...  tell netlogo where to find extensions

SET "JVM_OPTS=-Xmx1024m -XX:+UseParallelGC -Dfile.encoding=UTF-8 -Dnetlogo.extensions.dir=^"%BASE_DIR%app\extensions^""
